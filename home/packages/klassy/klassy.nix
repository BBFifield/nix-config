{ lib, stdenv, fetchFromGitHub, cmake, kdePackages, libsForQt5, qtMajorVersion ? "6", ... }:

  let
    qtPackages = { "5" = libsForQt5; "6" = kdePackages; }.${qtMajorVersion};
  in

  assert lib.assertOneOf "qtMajorVersion" qtMajorVersion [ "5" "6" ];
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    repo = "klassy";
    rev = "67f0584";
    hash = "sha256-S5J5/W4LBlocCV4xZqOX7v5EkeLsMfqu2QDvz/rtYow=";
  };
